...
class ClientBrowseableApiTestCase(TestCase):
    ...
    def test_clients_post(self):
        page = self.c.post("/api/clients/", {"name": fake.company()})
        self.assertEqual(page.status_code, 403)

        self.user.user_permissions.add(Permission.objects.get(codename="add_client"))
    ...
    def test_clients_post_unicode(self):
        ...
        page = self.c.post("/api/clients/", {"name": "Юникод"})
        self.assertEqual(page.status_code, 201)
...
class ProjectBrowseableApiTestCase(TestCase):
    ...
    def test_projects_post(self):
        ...
        page = self.c.post(
            "/api/projects/", {"client": clients[0]["url"], "name": fake.job()}
        )
    ...
    def test_projects_post_unicode(self):
        ...
        page = self.c.post(
            "/api/projects/", {"client": clients[0]["url"], "name": "Юникод"}
        )
...
class EntryBrowseableApiTestCase(TestCase):
    ...
    def test_entries_get(self):
        ...
        self.user.user_permissions.add(Permission.objects.get(codename="view_entry"))
    ...
    def test_entries_post(self):
        ...
        self.user.user_permissions.add(Permission.objects.get(codename="add_entry"))
