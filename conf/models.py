...
class Conf(models.Model):
    site = models.OneToOneField(Site, related_name="conf", on_delete=models.CASCADE)
    ...
    smtp_port = models.PositiveIntegerField(
        verbose_name="SMTP Port", blank=True, default=settings.EMAIL_PORT
    )
    smtp_tls = models.BooleanField(
        verbose_name="Use TLS", default=settings.EMAIL_USE_TLS
    )
